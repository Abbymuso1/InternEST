    ...
    >
      ...
      >
        <Stack spacing={0.5} sx={{ color: 'common.white', width: { xs: 0.5, md: 'auto' } }}>
          <Typography variant="h4">{fShortenNumber(200)}+</Typography>
      ...
      >
        <Stack spacing={0.5} sx={{ color: 'common.white', width: { xs: 0.5, md: 'auto' } }}>
          <Typography variant="h4">{fShortenNumber(20)}+</Typography>
          <Typography variant="body2" sx={{ opacity: 0.48 }}>
            Partners
          </Typography>
        </Stack>
            ...
            >
              <Stack spacing={3}>
                ...
                <Typography sx={{ color: 'grey.500' }}>
                  Introducing Employment Hero InternEst.
                  Get matched to great talent and companies instantly.
